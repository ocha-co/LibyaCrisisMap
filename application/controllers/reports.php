	...
	public function submit($id = false, $saved = false)
	{
		...
		if ($_POST)
		{
			...
			$post->add_rules('incident_photo', 'upload::valid',
											 'upload::type[gif,jpg,png,pdf]', 'upload::size[2M]');
			...
			if ($post->validate())
			{
				...
				//Add a log when a report is created. Added by Amaury 08.04.2011
				if(isset($_SESSION['auth_user']) &&$_SESSION['auth_user']->id){
