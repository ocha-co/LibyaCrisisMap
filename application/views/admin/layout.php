			...
			<div class="nav-holder">
				...
				<ul class="main-nav">
					<?php foreach($main_tabs as $page => $tab_name){ ?>
						<li><a href="<?php echo url::site(); ?>admin/<?php echo $page; ?>" <?php if($this_page==$page) echo 'class="active"' ;?>><?php echo $tab_name; ?></a></li>					<?php } ?>
						<li><a <?php if($this_page=="adminmap") echo 'class="active"' ;?> href="<?php echo url::site(); ?>admin/adminmap" >Map</a></li>
				</ul>
				<!-- sub-nav -->
				<ul class="sub-nav">
