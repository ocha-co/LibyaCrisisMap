			...
			<div class="bg">
				...
				<div class="tabs">
					...
					<ul class="tabset">
						...
						<li><a href="?status=x" <?php if ($status == 'x') echo "class=\"active\""; ?>><?php echo Kohana::lang('ui_main.unverified');?></a></li>
					</ul>
					<!-- tab -->
					<div class="tab">
						<ul>
							...
							<li><a href="#" onclick="reportAction('x','UNVERIFY', '');"><?php echo Kohana::lang('ui_main.unverify');?></a></li>
									...
									<tr>
										...
										<td class="col-4">
											<ul>
												...
												<li><a href="#"<?php if ($incident_verified == 1) echo " class=\"status_yes\"" ?> onclick="reportAction('v','VERIFY', '<?php echo $incident_id; ?>');"><?php echo Kohana::lang('ui_main.verify');?></a></li>
