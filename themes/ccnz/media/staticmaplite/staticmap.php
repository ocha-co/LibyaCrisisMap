...
Class staticMapLite {
	...
	public function copyrightNotice(){
			...
			imagecopy($this->image, $logoImg, imagesx($this->image)-imagesx($logoImg)-$this->width/2+10, imagesy($this->image)-imagesy($logoImg), 0, 0, imagesx($logoImg), imagesy($logoImg));
